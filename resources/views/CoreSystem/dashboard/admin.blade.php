...
<head>
    ...
    <title>Admin Dashboard - Smart EMS</title>
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    ...
                    <p class="text-3xl font-bold text-green-600">{{ \App\Models\Employee::where('status', 'Active')->count() }}</p>
                </div>
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                    <div class="flex items-center justify-between mb-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <a href="/employees" class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:border-indigo-200 transition group">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-slate-800">Employee Management</h3>
                            <p class="text-slate-500 text-sm mt-0.5">View, add, edit, and manage all employees</p>
                        </div>
                    </div>
                </a>
                <a href="/attendance" class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:border-indigo-200 transition group">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-slate-800">Attendance Dashboard</h3>
                            <p class="text-slate-500 text-sm mt-0.5">Monitor and manage attendance records</p>
                        </div>
                    </div>
                </a>
                <a href="/leave" class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:border-indigo-200 transition group">
                    <div class="flex items-center gap-4">
                ...
                <a href="/notifications" class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:border-indigo-200 transition group">
                    <div class="flex items-center gap-4">
                ...
                <a href="/report" class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:border-indigo-200 transition group">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-xl bg-rose-50 flex items-center justify-center group-hover:bg-rose-100 transition">
                ...
                <a href="/payroll" class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 hover:shadow-md hover:border-indigo-200 transition group">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            <h3 class="text-lg font-semibold text-slate-800">Payroll</h3>
