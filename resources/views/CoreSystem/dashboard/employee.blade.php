...
<div class="p-4 sm:p-6 lg:p-8 lg:pl-10 lg:pr-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
        <a href="/attendance" class="bg-white rounded-lg p-4 shadow-sm border border-slate-100 hover:shadow-md hover:border-blue-200 transition group">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center group-hover:bg-blue-100 transition shrink-0">
                ...
                <div class="min-w-0">
                    <h3 class="text-sm font-semibold text-slate-800">My Attendance</h3>
                    <p class="text-xs text-slate-500 mt-0.5">View your attendance records</p>
                </div>
            </div>
        </a>
