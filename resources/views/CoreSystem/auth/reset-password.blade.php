    ...
    <div class="w-full max-w-md mx-auto">
        <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
            <div class="text-center mb-6 sm:mb-8">
                <h1 class="text-2xl sm:text-3xl font-bold text-slate-800">Reset Password</h1>
                <p class="text-slate-500 mt-2 text-sm sm:text-base">Choose a new password for your account</p>
            </div>
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" value="{{ old('email', $email) }}" required readonly
                           class="w-full px-4 py-3 rounded-xl border border-slate-300 bg-slate-50 focus:outline-none text-sm sm:text-base">
                </div>
