...
<div class="p-4 sm:p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-slate-100">
            ...
            <p class="text-2xl sm:text-3xl font-bold text-green-600">{{ $employee->present_days }}</p>
        </div>
        <div class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-slate-100">
            <div class="flex items-center justify-between mb-3">
            ...
            <p class="text-2xl sm:text-3xl font-bold text-yellow-600">{{ $employee->leave_taken }}</p>
        </div>
        <div class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-slate-100">
            <div class="flex items-center justify-between mb-3">
            ...
            <p class="text-xl sm:text-2xl font-bold text-blue-600 break-words">{{ $employee->department }}</p>
        </div>
        <div class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-slate-100">
            <div class="flex items-center justify-between mb-3">
            ...
            <p class="text-xl sm:text-2xl font-bold text-slate-800 break-words">{{ $employee->position }}</p>
        </div>
    </div>
