<header class="bg-white shadow-sm border-b border-gray-200 overflow-x-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <!-- Logo -->
                <div class="flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-blue-100 shrink-0">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full lg:w-auto">
                ...
                <form action="{{ route('notifications.index') }}"
                    ...
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            class="w-full lg:w-72 pl-11 pr-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:outline-none">
                    </div>
                ...
                <div class="flex items-center justify-between sm:justify-start gap-4">
                    ...
                    <div class="flex items-center gap-3 bg-gray-50 rounded-xl border px-3 py-2">
                        ...
                        <div
                            class="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-blue-600 text-white flex items-center justify-center font-bold shrink-0">
